...
class CEMTD3:
    ...
    def _update_one_offspring(
        ...
        replay_buffer: ReplayBuffer,
        random_key: RNGKey,
    ) -> Tuple[Params, Params, Params, optax.OptState, ReplayBuffer, RNGKey]:
    ...
    def update(
        ...
        training_state: CEMTD3TrainingState,
        replay_buffer: ReplayBuffer,
    ) -> Tuple[CEMTD3TrainingState, ReplayBuffer, Metrics]:
    ...
    def scan_update(self, carry:Tuple[CEMTD3TrainingState,ReplayBuffer], unused:Any):
