"""Similar to cma_mega_emitter_v2.py, however now the gradient of f coming a critic
"""
...
class CMAMEGATD3Emitter(Emitter):
    def __init__(
        ...
        self._actor_network, self._critic_network, = make_td3_networks(
            ...
            policy_hidden_layer_sizes=config.policy_hidden_layer_size,
        )
    ...
    def _estimate_gradient_ES(
        ...
        f_gradients = jax.vmap(jax.grad(self._actor_loss_fn), in_axes=(0, None, None))( # need this weird vmap bcs the theta shape is (1, param_dim)
            emitter_state.theta,
